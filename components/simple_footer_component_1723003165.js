...
*/
Vue.component("simple_footer_component_1723003165", {
    template: `
                ...
                <div id="footer-content" class="text-center">
                    <div class="flex">
                        <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                            ...
                            MobileCraft - Build Your Dream Device
                        </a>
                    </div>
                </div>
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Unleash your creativity and construct cutting-edge mobile devices with MobileCraft. Explore endless possibilities, from sleek designs to innovative features. Join our community of passionate builders and bring your mobile masterpieces to life.
                    </div>
                </div>
            </div>
        </footer> 
